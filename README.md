...
- **[distro-builder](https://github.com/LevitateOS/distro-builder)** — Shared component system and build abstractions for ISO creation
...
- **[recinit](https://github.com/LevitateOS/recinit)** — Builds initramfs images without root using pure Rust CPIO
- **[reciso](https://github.com/LevitateOS/reciso)** — Creates bootable UEFI ISOs from kernel + initramfs + rootfs with systemd-boot
- **[recqemu](https://github.com/LevitateOS/recqemu)** — QEMU command builder with serial console and OVMF firmware discovery
...
- **[cheat-guard](https://github.com/LevitateOS/cheat_guard)** — Runtime macros for error handling with documented invalid fixes
...
- **[docs/tui](https://github.com/LevitateOS/docs-tui)** — Terminal UI documentation viewer with Ink-based rendering
...
- **[model-catalog](https://github.com/rbee-keeper/rbee/tree/main/bin/25_rbee_hive_crates/model-catalog)** — SQLite model registry per hive
...
- **[worker-provisioner](https://github.com/rbee-keeper/rbee/tree/main/bin/25_rbee_hive_crates/worker-provisioner)** — Worker lifecycle management
...
- **[timeout-enforcer](https://github.com/rbee-keeper/rbee/tree/main/bin/99_shared_crates/timeout-enforcer)** — Timeout enforcement macros
...
- **[lifecycle](https://github.com/rbee-keeper/rbee/tree/main/bin/96_lifecycle)** — Component lifecycle management
...
- **[VHX-starterkit](https://github.com/Cond8/core/tree/main/VHX-starterkit)** — Cloudflare Workers template with Hono + Preact SSR
